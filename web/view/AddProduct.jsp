                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="pID"   required=""  placeholder="Enter product ID"  >
                                              
                                            </div>
                                            <div class="form-group">
                                                <label>ProductName</label>
                                                <input class="form-control" name="pName" required="" placeholder="Enter product name ">
                                            </div>
                                            <div class="form-group">
                                                <label>Price</label>
                                                <input class="form-control" min="1" type="number" required="" name="pPrice" placeholder="Enter product price">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Stock</label>
                                                <input class="form-control" min="0" type="number" required="" name="pQuantity" placeholder="Enter product quantity">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                  <label>Author</label>
                                                  <input class="form-control"  required="" name="pAuthor" placeholder="Enter Author ">
