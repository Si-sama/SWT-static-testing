...
public class DAO extends DBContext {
    ...
    public List<Product> getAllProduct() {
        String sql = "SELECT * FROM Product WHERE StatusProduct !=1";
        ...
        try {
            ...
            while (rs.next()) {
                list.add(new Product(rs.getString("ProductID"),
                        ...
                        rs.getString("Author"),rs.getInt("StatusProduct")));
            }
        } catch (Exception ex) {
    ...
    public boolean OnCategory(String categoryID) {
         String sql = "Update Category set StatusCategory=0 WHERE CategoryID=?";
        try {
            PreparedStatement stm = connection.prepareStatement(sql);
     ...
     public boolean Onproduct(String ProductID) {
         String sql = "Update Product set StatusProduct=0 WHERE ProductID=?";
        try {
            PreparedStatement stm = connection.prepareStatement(sql);
    ...
    public List<Product> getAllProductByProductName(String name) {
        String sql = "SELECT * FROM Product where ProductName LIKE ? AND StatusProduct!=1";
        name += "%";
        String k ="%"+name;
        List<Product> list = new ArrayList<>();
        try {
    ...
    public List<Product> getAllProductByCategoryID(String name) {
    ...
    public boolean deleteProduct(String pID) {
        ...
        String sql = "Update Product Set StatusProduct=1 where ProductID=?";
        try {
            PreparedStatement stm = connection.prepareStatement(sql);
            stm.setString(1, pID);
    ...
    public boolean deleteCategory(String cateID) {
        ...
        String sql = "Update Category SET StatusCategory=1 where CategoryID=?";
        try {
            PreparedStatement stm = connection.prepareStatement(sql);
    ...
    public Category getCategoryByCateID(String id) {
        ...
        try {
            ...
            ResultSet rs = stm.executeQuery();
            if (rs.next()) {
                c = new Category(rs.getString("CategoryID"), rs.getString("CategoryName"),rs.getInt("StatusCategory"));
            }
        } catch (Exception ex) {
            System.out.println(ex);
        }
  ...
  public boolean checkPhoneNumberExist(String phone) {
      int count=0;
      String sql ="SELECT count(Phone) as nob froM User_Info where Phone=?";
       try {
            PreparedStatement stm = connection.prepareStatement(sql);
  ...
  public boolean checkCCCDNumberExist(String phone) {
      int count=0;
      String sql ="SELECT count(CCCD) as nob froM User_Info where CCCD=?";
       try {
            PreparedStatement stm = connection.prepareStatement(sql);
            stm.setString(1, phone);
            ResultSet rs= stm.executeQuery();
...
//        }
//        for (Product i : Instance.getAllProductByCategoryID("ADV")) {
//            System.out.println(i.getProductName());
//        }getPro
        System.out.println(Instance.getProductByID("ADV01").getStatusProduct());
