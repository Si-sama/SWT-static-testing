                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" required="" maxlength="3" name="CateID"   placeholder="Enter CategoryID"  >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label>
                                                            <input class="form-control" required="" name="CateName"   placeholder="Enter Category name"  >
