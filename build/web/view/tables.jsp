                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button id="productUpdate" name="updateProductButton" value="<%=product.getProductID()%>">Update</button></td>
                                                <td> <button id="productDelete" name="deleteProductButton" value="<%=product.getProductID()%>"> Hide </button>
                                            </td>
                                        </tr>
                                       <% }
                                           }%>
                                   ...
                                   <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=product.getCategory().getCategoryName()%></td>
                                            <td><%=product.getAuthor()%></td>
                                            <td><button id="productUpdate" name="OnProductButton" value="<%=product.getProductID()%>">ON</button></td>
                                                <td> 
                                            </td>
                                        </tr>
                                       <% }
                                    ...
                                    if(msg!=null) {
                                    %>
                                    <h3 style="color:red;text-transform: fullsize-kana"><%=msg%></h3>
                                    ...
                                    <tbody>
                                       ...
                                       %>
                                        <tr>
                                            ...
                                            <td><button id="categoryDelete" name="deletecategoryProductButton" value="<%=cate.getCategoryID()%>">Hide</button></td>
                                    ...
                                    <tbody>
                                       ...
                                       %>
                                        <tr>
                                            <td><%=cate.getCategoryID()%></td>
                                            <td><%=cate.getCategoryName()%></td>
                                            <td><button id="categoryUpdate" name="ONcategoryProductButton"  value="<%=cate.getCategoryID()%>">ON</button></td>
